defmodule Openmaize.Confirm do
  ...
  This function is designed to work with tokens generated by
  Openmaize.Signup.gen_token_link. You can use your own tokens,
  but they must be the same length, 32 bytes.
  ...
  * query_function - a custom function to query the database
  ...
  defp check_reset_key(user, valid_secs, key) do
